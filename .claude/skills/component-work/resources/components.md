...
- SaasDashboardMockup: 페이지 진입점. activeView 상태를 소유하고 SaasShell + 4개 뷰를 조합. isLoading/error/onRetry를 각 뷰로 내려보냄 (`components/templates/beautymaster/SaasDashboardMockup.jsx`)
